  ...
  RETURN QUERY (
    ...
    SELECT
      ...
      (CASE
        ...
        WHEN y.proposal_type in ('ParameterChange') AND NOT jsonb_path_exists(y.description, '$.** ? (exists(@."maxBlockBodySize") || exists(@."maxTxSize") || exists(@."maxBlockHeaderSize") || exists(@."maxValueSize") || exists(@."maxBlockExecutionUnits") || exists(@."txFeePerByte") || exists(@."txFeeFixed") || exists(@."utxoCostPerByte") || exists(@."govActionDeposit") || exists(@."minFeeRefScriptCostPerByte"))') THEN 0
